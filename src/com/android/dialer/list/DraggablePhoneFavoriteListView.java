 ...
 */
public class DraggablePhoneFavoriteListView extends GridView implements OnDragDropListener,
        DragItemContainer {

    public static final String LOG_TAG = DraggablePhoneFavoriteListView.class.getSimpleName();
    ...
    public DraggablePhoneFavoriteListView(Context context) {
        this(context, null);
    }

    public DraggablePhoneFavoriteListView(Context context, AttributeSet attrs) {
        this(context, attrs, -1);
    }

    public DraggablePhoneFavoriteListView(Context context, AttributeSet attrs, int defStyle) {
